...
public class DemandeCongeService : IDemandeCongeService
{
    ...
    public Task<int> CreateAsync(DemandeConge demande) => _repository.CreateAsync(demande);
    public Task<bool> UpdateAsync(DemandeConge demande) => _repository.UpdateAsync(demande);
